...
class Message {
    ...
    static mapping = {
        ...
        type(updateable: false, enumType: 'string', length: 5, index: 'idx_message_type')
        text(updateable: false, length: TEXT_MAX_LENGTH)
        textColor(updateable: false, length: 6)
        backgroundType(updateable: false, enumType: 'string', length: 10)
        backgroundColor(updateable: false, length: 6)
        backgroundImage(cascade: 'all-delete-orphan')
        language(updateable: false, enumType: 'string', length: 2)
        link(updateable: false, length: LINK_MAX_LENGTH)
        location(updateable: false, length: LOCATION_MAX_LENGTH)
